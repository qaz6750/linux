...
/*
 * Because this driver is mainly introduced for Gts6lwiFi, 
 * we default to Gts6lwiFi here.
*/
...
static void ptn36502_remove(struct i2c_client *i2c)
{
